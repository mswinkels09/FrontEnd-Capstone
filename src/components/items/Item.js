    ...
    return( 
        <section className="item">
            <h3><strong>
                ...
                <Link to={`/${item.id}`}>{item.name}</Link><div className="item__size">{item.size} oz</div>
                </div>
            </strong></h3>
            <div className="item__data_div">
                <div className="item__data">
                    <div className="item__data_title item__data_hours_title">HOURS SINCE CONSUMED:</div> <div className="item__data_data">{hours}</div> 
                </div>
                <div className="item__data">
